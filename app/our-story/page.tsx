    ...
    <>
      ...
      <section className="surface-cream section">
        <div className="container-narrow">
          <p className="font-display text-2xl sm:text-3xl lg:text-[2.25rem] leading-snug text-navy max-w-3xl mx-auto text-balance">
            ...
            <em className="text-crimson"> one client</em> who needed something for an event nobody else could dress her
            for.
          </p>
        </div>
      </section>
      ...
      <section className="surface-navy grain pt-20 pb-24 lg:pt-32 lg:pb-32">
        <div className="container-narrow">
          ...
          <ol className="relative max-w-2xl mx-auto pl-10 sm:pl-14 border-l-2 border-gold/30">
            {milestones.map((m) => (
              <li key={m._id} className="relative pb-12 last:pb-0">
                <span className="absolute -left-[2.6rem] sm:-left-[3.6rem] top-1 w-4 h-4 rounded-full bg-gold ring-4 ring-navy" aria-hidden="true" />
      ...
      <section className="surface-cream-warm section">
        <div className="container-site grid lg:grid-cols-2 gap-10 lg:gap-16">
          <div className="bg-cream rounded-md p-8 lg:p-10 border border-charcoal/10">
          ...
          <div className="bg-navy rounded-md p-8 lg:p-10 text-cream">
      ...
      <section className="surface-crimson grain section text-center">
        <div className="container-narrow">
          <p className="font-display italic text-xl sm:text-2xl lg:text-3xl text-ivory mb-6 leading-snug pretty-text max-w-3xl mx-auto">
            "I am not a designer. I am the woman who knows what you should wear before you do. After ten years of doing
            this, I will tell you what most stylists will not: the dress is never the answer. The woman is."
          </p>
