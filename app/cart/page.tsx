...
import { buildOrderWhatsAppLink } from "@/lib/cart";
...
export default function CartPage() {
  ...
  async function handleCheckout(e: FormEvent<HTMLFormElement>) {
    ...
    track("InitiateCheckout", { source: "cart-checkout", items: itemCount, value: subtotal });

    const wa = buildOrderWhatsAppLink(items, firstName);
    setSubmitting(false);
    setSent(true);
            ...
            <div className="lg:col-span-5 lg:sticky lg:top-28">
              <div className="bg-navy text-cream rounded-md p-7 lg:p-8 grain">
                ...
                <div className="flex items-center justify-between pb-4 border-b border-cream/15">
                  <span className="text-sm text-cream-warm/80">Subtotal</span>
                  <span className="font-display text-2xl text-gold">{formatNgn(subtotal)}</span>
                </div>
                {hasMadeToMeasure && (
                ...
                <p className="text-xs text-cream-warm/70 leading-relaxed mt-3 mb-6">
